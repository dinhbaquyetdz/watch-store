...
// $getspgh=mysqli_query($conn,"SELECT soluong FROM giohang WHERE id='$idsp'");
      ...
      if($thanhtoan==2){
        if($wallet > ($price * $soluong)){
          ...
          $slht = $slsau - $soluong;
            ...
            $addgh="INSERT INTO donhang (`id_sp`,`id_khachhang`,`address`,`soluong`,`thanhtoan`,`trangthai`,`thoigian`,`gia`) VALUES ('$idsp','$id','$address','$soluong','2','0',CURRENT_TIME,'$price')";
            ...
            $deletegh=mysqli_query($conn,"DELETE FROM giohang WHERE id_sp='$idsp' AND id_khachhang='$id'");
...
<!-- content -->
    <div class="row mt-5">
        ...
        <div class="col-10">
            ...
            <div class="row  p-3 mb-5 bg-body-tertiary rounded">
                ...
                <table >
                    ...
                    <?php
                            if($row2){
                                ...
                                <tr>
                                <th>Số lượng: </th>
                                <td><input type='number' name='soluong' min='1' max='$sl' value='1'></td>
                                </tr>
                                <tr>";?>
