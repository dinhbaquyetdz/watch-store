...
if(isset($_GET['idsp'])){
  ...
  $query4=mysqli_query($conn,"SELECT dangki.ho,dangki.ten,dangki.image,comment.cmt FROM comment INNER JOIN dangki ON comment.id_khachhang=dangki.id WHERE comment.id_sp='$idsp'"); 
    ...
    if(isset($_POST['comment'])){
      $cmt=$_POST['cmt'];
      $comment="INSERT INTO comment (`id_sp`,`id_khachhang`,`cmt`) VALUES ('$idsp','$id','$cmt')";
      if($conn->query($comment)===true){
        header("location: cmt.php?idsp=$idsp");
      }else{
        // print_r($comment);die();
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  <div class="dropdown">
                      <span><?php if(!empty($row['image'])){echo '<img src="photo/'.$row['image'].'" alt=""  style="width: 50px; height: 50px; border-radius: 100%; border-color: aquamarine; margin: 0 15px;">';}
                                  else{?><img src="image/avata1.jpg" alt=""  style="width: 50px; height: 50px; border-radius: 100%; border-color: aquamarine; margin: 0 15px;">
                    <?php } ?></span>
        ...
        <div class="col-10">
            ...
            <div class="row shadow p-3 mb-5 bg-body-tertiary rounded">
                ...
                <?php
                        ...
                        else{?><img src="image/avata1.jpg" alt=""  style="max-width: 500px; height: 400px; border-radius: 100%; border-color: aquamarine; margin: 0 15px;">
                ...
                <div class="col-7">
                        <table >
                            ...
                            if($row2){
                                ...
                                <tr>";?>
                                <td><a style='text-decoration: none; color: black;' href="buy.php?idsp=<?php echo $id ?>"><button type="submit" name="mua" class="btn btn-info">Mua lại</button></a>
                                <a href="CTsanpham.php?idsp=<?php echo $id ?>"><img src='image/giỏ hàng.jpg' style="width: auto; height: 50px;"></a></td>
                                <?php echo "</tr>
                                ";
                                }?>
                                <tr>
                                    ...
                                    <form action="" method="post" >
                                        <textarea name="cmt" id="" style="max-height: 50px;" cols="30" rows="10" placeholder="Viết đánh giá"></textarea><br>
                                        <button type="submit" name="comment" class="btn btn-primary">Đăng</button>
                                    </form>
                                    </td>
                                </tr>
                            </table>  
