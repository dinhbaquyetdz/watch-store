...
<body>
    ...
    <div class="header sticky-top shadow pb-1 mb-2">
      ...
      <div class='row' style='z-index: 1;position: absolute;'>
            <div class='col-3'></div>
            <div class='col-7 shadow p-3 mb-5 mt-5 bg-body-tertiary rounded '>
                ...
                <div class='row'>
                    <div class='col-8'>
                        ...
                        <div class='col-3'>
                         <?php
                          if(!empty($row['image'])){echo '<img src="photo/'.$row['image'].'" alt=""  style="width: 50px; height: 50px; border-radius: 100%; border-color: aquamarine; margin: 0 15px;">';}
                          else{?><img src="image/avtjpg.jpg" alt=""  style="max-width: 100px; height: 100px; border-radius: 100%; border-color: aquamarine; margin: 0 15px;">
                          
                         <?php }?>  
                         <a href="udusinshop.php?id=<?php echo $id ?>" style="margin: 0 15px;">Chỉnh sửa</a>
                        </div>
                        <div class="col-8">
                            <table class="">
                                ...
                                <?php
                                if($row){
                                    if(!empty($row['image'])){echo '<img src="photo/'.$row['image'].'" alt=""  style="max-width: 50px; max-height: 50px; border-radius: 100%; border-color: aquamarine; margin: 0 15px;">';}
                                    else{?><img src="image/avtjpg.jpg" alt=""  style="max-width: 100px; max-height: 100px; border-radius: 100%; border-color: aquamarine; margin: 0 15px;">
                                    ...
                                    <tr><a href='donhang.php'>Danh sách đã mua </a> <br>
                                    <a href='wallet.php'>nạp tiền</a><span>/</span><a href='giaodich.php'> lịch sử giao dịch</a>
                                    </tr>
                                    ";
                                }else{
                                    echo "<h2 style='color:red;'>Không có thông tin</h2>";
                                }
                                ?>
                            </table>
                        </div>
